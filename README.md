...
- :white_check_mark: Что такое качество ПО?
    - Определения качества ПО
    - Характеристики и атрибуты качества ПО
    - Основные аспекты качества ПО
- :white_check_mark: Парадокс тестировщика
- :white_check_mark: Соответствие ожиданиям stakeholder'ов
- :white_check_mark: Качество & деньги
    - Десятичное правило стоимости качества
    - Важные аспекты
- :white_check_mark: Ручное тестирование
    - Основные определения
    - Практические аспекты
- :white_check_mark: Семь инструментов качества
...
- :white_check_mark: Автоматизированное тестирование
    - Основные преимущества и недостатки
    - Жизненный цикл автотеста
    - Практические аспекты


### [Лекция 15](https://github.com/demist/is_design/blob/main/lecture15.pdf)

- :white_check_mark: Общее понятие информационной безопасности
- :white_check_mark: Виды требований информационной безопасности
    - Функциональные требования
    - Требования доверия
- :white_check_mark: Угрозы информационной безопасности
- :white_check_mark: Классы функциональных требований к безопасности
- :white_check_mark: Классы требований доверия к безопасности
- :white_check_mark: Основные понятия
    - Атака
    - Механизм безопасности
    - Сервис безопасности
- :white_check_mark: Классификация атак
    - По месту возникновения
    - По воздействию на ИС
- :white_check_mark: Примеры сетевых атак
    - Пассивная атака
    ...
    - Фальсификация
    - Replay-атака
- :white_check_mark: Типы сервисов безопасности
- :white_check_mark: Классификация мер безопасности
- :white_check_mark: Ликбез
    - Аутентификация и авторизация
    - С чем будете постоянно сталкиваться?
- :white_check_mark: Отражение безопасности в требованиях
- :white_check_mark: Основные принципы безопасности ИС
...
**:end: Дедлайн** *(если у вашей группы семинар по диаграммам вариантов использования еще не прошел)*: **03/10/2021 23:59**

### :white_check_mark: Задание на диаграмму деятельности / последовательности (ЗДД)
...
**:end: Дедлайн** *(если у вашей группы семинар по диаграммам деятельности / последовательности уже прошел)*: **03/10/2021 23:59**

**:end: Дедлайн** *(если у вашей группы семинар по диаграммам деятельности / последовательности еще не прошел)*: **10/10/2021 23:59**

### :white_check_mark: Командный (3-5 человек) проект на написание ТЗ (ПрТЗ)
...
**:end: Дедлайн**: *заранее присылаете ваше **ТЗ** семинаристу (каждый семинарист сам устанавливает срок в зависимости от вашего графика), далее на последнем семинаре курса защищаете свою работу (рассказываете презентацию)*

### :white_check_mark: Письменный экзамен (ЭКЗ)

:end: **Пройдет онлайн 19 октября в 11:10 - 12:30**

**Ключевые моменты**:
- **Темы для экзамена**: все, что было на лекциях
- Экзамен онлайн на базе Google Forms
- На выполнение у вас **1 час**
- Вопросы - только тестовые (разные вопросы могут стоить разное количество баллов)
- Общий балл за контрольную: **40**
- В таблицу с расчетом оценки будет вноситься так: *ЭКЗ* = *Балл за контрольную* / 4
- Нормировок / усреднений / округлений и т.п. не будет
- **Ожидаемый срок публикации результатов: 20 октября, возможно, раньше**
